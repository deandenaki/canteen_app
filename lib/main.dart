...
import 'package:canteen_app/presentation/home/blocs/products/products_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        BlocProvider(
          create: (context) => ProductsBloc(ProductRemoteDatasouce())..add(ProductsFetched())
        ),
      ...
      child: MaterialApp(
        ...
        home: FutureBuilder(
          future: AuthLocalResource().isAuthData(),
